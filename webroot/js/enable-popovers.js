 ...
 * ## Description
 *
 * This script automates the initialization of Bootstrap popovers for all elements that use the
 *  `data-bs-toggle="popover"` attribute. It converts standard HTML elements into interactive popovers that can display
 *  additional content when triggered.
 *
 * ## Features
 *
 * - Automatic initialization on page load
 * - Uses Bootstrap's Popover component
 * - Targets elements with the `data-bs-toggle="popover"` attribute
